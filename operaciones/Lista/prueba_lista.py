...
personajes_star_wars.sort(key=by_hegiht)  #en este caso ordena por altura

#! busqueda elementos simples
try:
    print('posicion', personajes_star_wars.index('Yoda'))  #Esto sirve para que en vez de que salte 
except ValueError:                                         #el error que se menciona(ValueError),
    print('el elemento que busca no esta en la lista')     #salte lo que esta en print
