...
species_a_buscar = ['Human', "Twi'lek"]
...
def filtrar_nombre(jedis, letter):
    filtered_jedis = []
    for jedi in jedis:
        if jedi['name'].lower().startswith(letter.lower()):
...
# g) 
def jedi_with_yellow_or_purple_lightsaber(jedis):
    result = []
    for jedi in jedis:
        if jedi['lightsaber_color'] and ("Yellow" in jedi['lightsaber_color'] or "Purple" in jedi['lightsaber_color']):
            result.append(jedi['name'])
    return result

jedi_with_special_sabers = jedi_with_yellow_or_purple_lightsaber(jedis)

print("Jedi que utilizaron sable de luz amarillo o violeta:")
for jedi in jedi_with_special_sabers:
    print(jedi)
...
def find_padawans(jedis, masters):
    padawans = []
    for jedi in jedis:
...
padawans = find_padawans(jedis, masters_to_find)
...
def find_jedi_by_rank(jedis, rank):
    grand_masters = []
    for jedi in jedis:
...
grand_masters = find_jedi_by_rank(jedis, rank_to_find)

print("Jedi con el ranking de Grand Master:")
