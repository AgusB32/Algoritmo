...
super1 = "Mujer Maravilla"
super2 = "Capitana Marvel"

index_super1 = search(super_heroes, 'nombre', super1)
if index_super1 is not None:
    print(f"{super1} pertenece a la casa: {super_heroes[index_super1].casa_comic}")

index_super2 = search(super_heroes, "nombre", super2)
if index_super2 is not None:
    print(f"{super2} pertenece a la casa: {super_heroes[index_super2].casa_comic}")
